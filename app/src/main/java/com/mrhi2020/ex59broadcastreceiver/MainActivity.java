package com.mrhi2020.ex59broadcastreceiver;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickBtn(View view) {
        //명시적 인텐트로 리시버 실행하기 : 같은 앱안에 있는 리시버만 실행할 수 있음.[메니페스트에 등록이 되어 있어야 함]
    ...
    // - 개발자의 임의로 보내는 방송은 [동적 리시버 등록]을 해야만 동작함.
    // 즉, Manifest.xml에 리시버를 등록하지 않고 JAVA코드로 리시버를 등록!!-[동적 리스버 등록]
